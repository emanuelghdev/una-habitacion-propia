...
public class DialogosSpawner : MonoBehaviour
{
	...
	private void Start()
	{
		// Encontrar el objeto con el tag "Spawner" para empezar el ejercicio tras la explicación
	...
	private void Update()
	{
		if(!dialogoIniciado && !dialogoTerminado)
		{
			EmpezarDialogo();
		}
		else if(!dialogoTerminado && (Input.GetButtonDown("Fire1") || Input.GetKeyDown(KeyCode.Space) || Input.GetKeyDown(KeyCode.Return)))
		{
